...
<main>
	...
	<col style="width:25%">
		...
		<form action="update_.php" method="post">
			...
			<tr><td>
			Phone:  </td><td><input type="text" name="phone" pattern="(?:\(\d{3}\)|\d{3})[- ]?\d{3}[- ]?\d{4}" value=<?php echo "'$phone'"?>><br>
			</td></tr>
			<tr><td>
			Email:  </td><td><input size="50" type="email" min="1" max="50" name="email" required="required" value=<?php echo "'$email'"?>><br>
			</td></tr>
			<tr><td>
			Password:  </td><td><input type="text" name="password" minlength="6" maxlength="21" value=<?php echo "'$password'"?>><br>
			</td></tr>
